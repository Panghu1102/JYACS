...
init 15 screen jyacs_settings():
    ...
    default api_key = persistent.jy_ai_api_key
    default api_url = persistent.jy_ai_api_url
    default model_name = persistent.jy_ai_model_name
    ...
    frame:
        ...
        vbox:
                        ...
                        frame:
                            ...
                            vbox:
                                ...
                                hbox:
                                    ...
                                    input:
                                        id "api_key_input"
                                        value ScreenVariableInputValue("api_key")
                                        copypaste True
                                ...
                                hbox:
                                    ...
                                    input:
                                        id "api_url_input"
                                        value ScreenVariableInputValue("api_url")
                                        copypaste True
                                        style "jyacs_input_style"
                                ...
                                hbox:
                                    ...
                                    input:
                                        id "model_name_input"
                                        value ScreenVariableInputValue("model_name")
                                        copypaste True
                                        style "jyacs_input_style"
            ...
            hbox:
                ...
                textbutton "保存设置" action [SetField(persistent, "jy_ai_api_key", api_key), SetField(persistent, "jy_ai_api_url", api_url), SetField(persistent, "jy_ai_model_name", model_name), Function(store.jyacs_apply_setting), Hide("jyacs_settings")] style "jyacs_button"
