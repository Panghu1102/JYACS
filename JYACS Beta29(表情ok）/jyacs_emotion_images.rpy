        ...
        def show_emotion_image(self, emotion_name):
            ...
            try:
                ...
                if os.path.exists(image_path):
                    ...
                    renpy.show("jyacs_emotion_{}".format(display_name), layer="master")
                    return True
                else:
                    # 如果特定表情不存在，使用normal
                    print("表情图片不存在: {}，使用normal".format(image_path))
                    renpy.scene(layer="master")
                    renpy.show("jyacs_emotion_normal", layer="master")
                    return False
...
init -1100:
    # 使用im.Scale确保图片能够适应屏幕尺寸
    image jyacs_emotion_happy = im.Scale("mod_assets/images/emotins/happy.png", config.screen_width, config.screen_height)
    image jyacs_emotion_sad = im.Scale("mod_assets/images/emotins/sad.png", config.screen_width, config.screen_height)
    image jyacs_emotion_normal = im.Scale("mod_assets/images/emotins/normal.png", config.screen_width, config.screen_height)
    image jyacs_emotion_normal2 = im.Scale("mod_assets/images/emotins/normal2.png", config.screen_width, config.screen_height)
    image jyacs_emotion_normal3 = im.Scale("mod_assets/images/emotins/normal3.png", config.screen_width, config.screen_height)
    image jyacs_emotion_relaxed = im.Scale("mod_assets/images/emotins/relaxed.png", config.screen_width, config.screen_height)
    image jyacs_emotion_kind = im.Scale("mod_assets/images/emotins/kind.png", config.screen_width, config.screen_height)
    image jyacs_emotion_a_little_sad = im.Scale("mod_assets/images/emotins/a little sad.png", config.screen_width, config.screen_height)
    image jyacs_emotion_think_and_interested = im.Scale("mod_assets/images/emotins/think and interested.png", config.screen_width, config.screen_height)
    image jyacs_emotion_think_and_a_little_worry = im.Scale("mod_assets/images/emotins/think and a little worry.png", config.screen_width, config.screen_height)
    image jyacs_emotion_relaxing_and_happy = im.Scale("mod_assets/images/emotins/relaxing and happy.png", config.screen_width, config.screen_height)
    image jyacs_emotion_unhappy = im.Scale("mod_assets/images/emotins/unhappy.png", config.screen_width, config.screen_height)
